...
class StatsAccumulatorTest {
    ...
    void startsEmpty() {
        ...
        assertThat(empty.distance()).isEqualTo(com.runtrack.shared.measure.Distance.ZERO);
    ...
    void tracksHeartRateAndAltitudeExtremes() {
        ...
        assertThat(accumulator.minAltitude()).map(com.runtrack.shared.measure.Elevation::meters).contains(90.0);
        assertThat(accumulator.maxAltitude()).map(com.runtrack.shared.measure.Elevation::meters).contains(140.0);
    }
